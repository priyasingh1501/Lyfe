          ...
          >
            ...
            >
              ...
              <div className="space-y-6">
                ...
                {/* Benefits */}
                <div className="bg-gradient-to-r from-[#3CCB7F]/20 to-[#4ECDC4]/20 rounded-lg p-4 border border-[#3CCB7F]/30">
                ...
                <div className="flex gap-3">
                  ...
                  <Button
                    ...
                    className="flex-1 bg-gradient-to-r from-[#3CCB7F] to-[#4ECDC4]"
                  >
                    Refresh
                  </Button>
                </div>
