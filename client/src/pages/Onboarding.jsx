...
const Onboarding = () => {
  ...
  const steps = [
      ...
      content: (
        <div className="text-center space-y-6">
          <motion.div
            ...
            className="mx-auto w-24 h-24 bg-gradient-to-r from-accent-yellow via-[#1E49C9] to-[#1E49C9] rounded-3xl flex items-center justify-center shadow-2xl"
          >
    ...
    },
    {
      ...
      icon: <Target className="w-16 h-16 text-[#1E49C9]" />,
      content: (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            {
              icon: <BookOpen className="w-8 h-8 text-[#1E49C9]" />,
            ...
            {
              icon: <Utensils className="w-8 h-8 text-[#1E49C9]" />,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="p-4 bg-background-secondary/30 rounded-xl border border-border-primary/20 hover:border-[#1E49C9]/50 transition-all duration-200 text-left group"
              >
                <div className="flex items-center space-x-3">
                  <div className="text-[#1E49C9] group-hover:text-[#1E49C9] transition-colors">
                    {goal.icon}
                  </div>
        ...
        <div className="space-y-8">
          <div className="space-y-6">
            <div>
              ...
              <select className="w-full p-3 bg-background-secondary/50 border border-border-primary/20 rounded-xl text-text-primary focus:outline-none focus:ring-2 focus:ring-[#1E49C9]/50">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {[
                  ...
                  <button
                    key={option}
                    className="p-3 bg-background-secondary/30 border border-border-primary/20 rounded-lg text-text-primary hover:border-[#1E49C9]/50 transition-colors text-left"
                  >
                    {option}
                  </button>
                ))}
    ...
    },
    {
      ...
      icon: <CheckCircle className="w-16 h-16 text-[#1E49C9]" />,
      content: (
        <div className="text-center space-y-6">
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
            transition={{ delay: 0.2, type: "spring", stiffness: 200 }}
            className="mx-auto w-32 h-32 bg-gradient-to-r from-[#1E49C9] to-[#1E49C9] rounded-full flex items-center justify-center shadow-2xl"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
            {[
              ...
              >
                <div className="text-[#1E49C9]">{item.icon}</div>
        ...
        <Card className="p-8 md:p-12">
          ...
          <div className="mb-8">
            ...
            <div className="w-full bg-background-secondary/30 rounded-full h-2">
              <motion.div
                className="bg-gradient-to-r from-[#1E49C9] to-[#1E49C9] h-2 rounded-full"
                initial={{ width: 0 }}
          ...
          <div className="flex items-center justify-between mt-8 pt-6 border-t border-border-primary/20">
            ...
            {isLastStep ? (
              <Button
                ...
                loading={loading}
                className="flex items-center space-x-2 bg-gradient-to-r from-[#1E49C9] to-[#1E49C9] hover:from-accent-green/90 hover:to-accent-teal/90"
              >
