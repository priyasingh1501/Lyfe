  ...
  return (
    ...
    >
      <div className="bg-gray-900 border-2 border-gray-600 rounded-lg p-6 relative overflow-hidden" style={{ clipPath: 'polygon(0 0, calc(100% - 6px) 0, 100% 6px, 100% 100%, 6px 100%, 0 calc(100% - 6px))' }}>
        ...
        <h1 className="text-2xl font-bold text-white mb-4 font-oswald tracking-wide">PROFILE MISSION</h1>
        <p className="text-gray-300 font-inter">Profile management and settings features coming soon!</p>
      </div>
    </motion.div>
  );
};
