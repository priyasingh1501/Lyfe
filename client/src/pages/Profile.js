            ...
            <Card className="p-6">
              ...
              <div className="flex items-center gap-6 mb-6">
                <div className="relative">
                  <div className="w-20 h-20 bg-gradient-to-br from-accent-green to-accent-blue rounded-full flex items-center justify-center text-2xl font-bold text-white">
                  ...
                  {isEditing && (
                    <button className="absolute -bottom-1 -right-1 w-6 h-6 bg-accent-green rounded-full flex items-center justify-center text-white hover:bg-accent-green/90 transition-colors">
                      <Camera size={12} />
                    </button>
                  )}
                </div>
